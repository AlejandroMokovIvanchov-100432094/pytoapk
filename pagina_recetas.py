...
class SeccionRecetas:
    ...
    def pagina_principal(self):
        ...
        self.layout_alimentos = GridLayout(cols=1, spacing=10, height=len(self.alimentos) * back_btn_size[1],size_hint_y=None)
    ...
    def pagina_cantidades(self, instance):
        ...
        self.layout_totales = GridLayout(cols=2)

        self.layout_cantidades = GridLayout(cols = 1)
        self.main_layout.add_widget(self.layout_cantidades)

        back_btn_size = (self.main_layout.size[0] * 0.5, self.main_layout.size[1] * 0.1)
        self.back_btn_cant = Button(text='Volver', on_press=partial(self.back_btn_cantidades, self), height=back_btn_size[1],size_hint_y=None)
        self.layout_cantidades.add_widget(self.back_btn_cant)

        self.btn_insulina = Button(text='Calcular insulina', on_press=self.calcular_insulina,height=back_btn_size[1]*0.5,size_hint_y=None)
    ...
    def calcular_insulina(self, instance):
        ...
        insulina_desayuno_boton = Button(text= "Unidades desayuno", height=back_btn_size[1]*0.5,size_hint_y=None, on_press = self.add_widget_desayuno)
        insulina_comida = Label(text="Insulina comida: ", height=back_btn_size[1]*0.5,size_hint_y=None)
        insulina_comida_boton = Button(text= "Unidades comida", height=back_btn_size[1]*0.5,size_hint_y=None, on_press = self.add_widget_comida)
    ...
    def add_widget_desayuno(self, instance):
        ...
        self.layout_cantidades.add_widget(self.insulina_desayuno_valor)
    ...
    def add_widget_comida(self, instance):
        ...
        self.insulina_comida_valor = Label(text=str(unidades_necesarias_comida) + " unidades", height=back_btn_size[1] * 0.5,
                                      size_hint_y=None)

        self.layout_cantidades.add_widget(self.insulina_comida_valor)
    ...
    def add_widget_cena(self, instance):
        ...
        self.layout_cantidades.add_widget(self.insulina_cena_valor)
    ...
    def config_layout_totales(self, back_btn_size):
        self.calorias = Label(text="Calorias totales:", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.7, size_hint_x=None)
        self.calorias_value = Label(text="0", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.3, size_hint_x=None)
        self.layout_totales.add_widget(self.calorias)
        self.layout_totales.add_widget(self.calorias_value)
        self.hc = Label(text="Hidratos de carbono totales:", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.7, size_hint_x=None)
        self.hc_value = Label(text="0", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.3, size_hint_x=None)
        self.layout_totales.add_widget(self.hc)
        self.layout_totales.add_widget(self.hc_value)
        self.azucares = Label(text="de los cuales azúcares:", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.7, size_hint_x=None)
        self.azucares_value = Label(text="0", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.3, size_hint_x=None)
        self.layout_totales.add_widget(self.azucares)
        self.layout_totales.add_widget(self.azucares_value)
        self.proteinas = Label(text="Proteinas totales:", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.7, size_hint_x=None)
        self.proteinas_value = Label(text="0", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.3, size_hint_x=None)
        self.layout_totales.add_widget(self.proteinas)
        self.layout_totales.add_widget(self.proteinas_value)
        self.grasas = Label(text="Grasas totales:", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.7, size_hint_x=None)
        self.grasas_value = Label(text="0", height=back_btn_size[1] * 0.5, size_hint_y=None, width =  self.main_layout.size[0] * 0.3, size_hint_x=None)
